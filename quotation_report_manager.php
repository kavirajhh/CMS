    ...
    <div class="col-lg-12">
        ...
        <?php include_once('db/error.php'); ?>
            <div class="panel-body">
                <div class="form-row"> 
                    <h2 class="pageheader-title" style="margin-bottom: 50px;"><i class="fa fa-filter" aria-hidden="true"></i>Sent Quotations</h2>
                </div>
                    ...
                    <table id="loadData1" class="table table-striped table-bordered table-hover display" ><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <?php
                          ...
                          /*  $USER_ID=$_SESSION['idUsers'];
                            ...
                            $get_invoice = "SELECT * FROM student_registration2 WHERE Country='$con_id' AND delstatus=0";
                            $run_invoice = mysqli_query($conn, $get_invoice);
