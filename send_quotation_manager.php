...
function inv_no($conn,$id)
                    {
                    $sql1 = "SELECT invoiceno  FROM student_registration2 where invoiceno like'".$id."%'";
...
if (!isset($_SESSION['Username'])) {
        ...
        if (isset($_POST['qsubmit'])) 
            ...
            if (count($error)==0)
                 {
                    $sql="INSERT INTO student_registration2(FName,LName,Country,Tp,Email,organizaton,position,contact_through,Courseid,CourseFee,discount,SenderId,date,rate,no_part,comments) VALUES('$fname','$lname','$get_country','$stp','$semail','$org','$position','$contactT','$course','$Course_fee','$discount','$current_userid',NOW(),$currency_rate,$no_part,'$comments')";
                    $run_Rproduct= mysqli_query($conn, $sql);
                    


                    $last_id = $conn->insert_id;
                    //to add invoice no to database
                    $invoiceno=$last_inv.sprintf("%02d",$last_id2);
                    $update_invno = "UPDATE student_registration2 SET invoiceno='$invoiceno'  WHERE idstudent='$last_id' LIMIT 1";
...
// Student address for mail
                       ...
                       if (!empty($position)) 
                        ...
                        $message = '<html>
                                    ...
                                    <tr bgcolor=#4484ce><td colspan=4><br><h1 align="center" ><font color=white>QUOTATION</font></h1><br></td>
                                    ...
                                    <b>Quotation No :</b>'.$invoiceno.'<br><b>Date :</b>'.$date.'</td></tr>
                                    ...
                                    <tr><td colspan=4><br><br><br>Best Regards<br><br><br><br><b>'.$sender.'</b><br><br><br><br>
                                    '. $user_des.'<br>
                        ...
                        echo '<div class="alert alert-success">Quotation Sent Successfully</div>';
            ...
            <div class="panel-body">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title tcolor"><i class="fa fa-paper-plane" aria-hidden="true"></i>  Create Quotation</h2>
                    ...
                    <form  method="POST"  enctype="multipart/form-data" >
						<div class="form-row" style="margin-top: 20px;">
							...
							<div class="form-group col-md-6">
							<label  class="tcolor" >Select Program</label>
