...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="page-header">
        <h2 class="pageheader-title"><i class="fa fa-user-plus" aria-hidden="true"></i>Update password</h2>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div>
            <form  method="POST" action="chnge_pw.php" enctype="multipart/form-data">
						<div class="form-row" style="margin-top: 20px;">
                            ...
                            <div class="form-group col-md-12">
                                    <input type="submit" class="btn btn-primary form-control" name="update" value="Update password">
                            </div>
						</div>
					</form>
				    </div>
