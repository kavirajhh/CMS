                    ...
                    <table id="loadData1" class="table table-striped table-bordered table-hover display" ><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <!-- if isset filter print this body -->
                            ...
                            if(isset($_GET['from_date']) && isset($_GET['to_date']))
                            {
                                ...
                                $get_invoice = "SELECT * FROM student_registration2 WHERE date BETWEEN '$from_date' AND '$to_date' AND Country='$con_id' AND delstatus=0";
                        ...
                        <?php
                            ...
                            $get_invoice = "SELECT * FROM student_registration2 WHERE SenderId='$USER_ID' AND delstatus=0";
                            $run_invoice = mysqli_query($conn, $get_invoice);
                            ...
                            <tr>
                                ...
                                <td style="background-color: #4637aab2; color: #fff;" align=right> <?php echo $currency.' '.number_format($total, 2); ?> <?php //echo $currency; ?></td>
                            </tr>  
                        </tbody>
                    </table>
	</div>
