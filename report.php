    ...
    <div class="col-lg-12">
        ...
        <?php include_once('db/error.php'); ?>
            <div class="panel-body">
                <div class="form-row"> 
                    <h2 class="pageheader-title" style="margin-bottom: 50px;"><i class="fa fa-filter" aria-hidden="true"></i>Invoice Report</h2>
                </div>
                    ...
                    <table id="loadData1" class="table table-striped table-bordered table-hover display" ><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <!-- if isset filter print this body -->
                            ...
                            if(isset($_GET['country']) || isset($_GET['from_date']) && isset($_GET['to_date']))
                            {
                                ...
                                $get_invoice = "SELECT * FROM student_registration WHERE date BETWEEN '$from_date' AND '$to_date' AND Country='$country' AND delstatus=0 ";
