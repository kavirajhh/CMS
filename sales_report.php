                        ...
                        <thead>
                            <tr>
                               ...
                               <!-- <th>Country Code</th> -->
                                <th>Country</th>
                                <th>Total Sales</th>
                                <th>Country coordinator's Share:</th>
                                <th>Regional coordinator's Share:</th>
						...
						<?php
							if (isset($_GET['country']) || isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                ...
                                // $country=get_active_country($conn);
                                    ...
                                    echo "<tr><td> $cname</td><td>$initotal </td><td>  $discount</td><td> $gtotal </td></tr>";
                               ...
                               echo "<tr height=10px><td></td></tr>
                                    <tr style='background-color: #86868B;color: #fff;'>  
                                    <th> Monthly sales </th>  
                                    <th>".$gst."</th>
                                    <th>".$gd."</th>
                                    <th> ".$tgst." </th>
