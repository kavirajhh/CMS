...
<body class="app sidebar-mini">
  <div class="pre-loader"></div>
    <header class="app-header"><a class="app-header__logo" href="home.php">CMS</a>
      ...
      <ul class="app-nav">
            ...
            <li><a class="app-nav__item" >
              <img  src="images/flags/<?php echo strtoupper($_SESSION['countrycode']);  ?>.png" width=150% ></a></li>
      </ul>
...
<?php }else{ ?>
        <li class="treeview" ><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-envelope-o"></i><span class="app-menu__label">Quotatios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="send_quotation_manager.php "><i class="icon fa fa-plus"></i> Send Quotation</a></li>
            <li><a class="treeview-item" href="sent_quatations.php"><i class="icon fa fa-pencil"></i>Sent quotations</a></li>
          </ul>
        </li>
<?php }?>
...
<?php }else{ ?>
        <li class="treeview" ><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-envelope"></i><span class="app-menu__label">Invoices</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="send_invoice_manager.php "><i class="icon fa fa-plus"></i> Send Invoice</a></li>
            <li><a class="treeview-item" href="manage_student_manager.php"><i class="icon fa fa-pencil"></i>Sent Invoices</a></li>
          </ul>
        </li>
<?php }?>
...
?>
        <li class="treeview" ><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-retweet"></i><span class="app-menu__label">Course</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="add-corse.php"><i class="icon fa fa-plus"></i>Add New Couese</a></li>
            <li><a class="treeview-item" href="manage_courses.php"><i class="icon fa fa-pencil"></i>Edit Couese</a></li>
          </ul>
        </li>
<?php }else{?>
        <li class="treeview" ><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-retweet"></i><span class="app-menu__label">Course</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="add-corse.php"><i class="icon fa fa-plus"></i>Add New Couese</a></li>
            <li><a class="treeview-item" href="manage_courses_manager.php"><i class="icon fa fa-pencil"></i>Edit Couese</a></li>
          </ul>
        </li>
<?php }?>
...
$access=$_SESSION['privilages'];
  if (strpos($access, 'd') !== false) {
?>
        <li class="treeview" ><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-print"></i><span class="app-menu__label">Bank Details</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="update_bankdetail.php"><i class="icon fa fa-plus"></i>Bank Details </a></li>
...
?>
                <li class=""><a class="app-menu__item" href="countries.php"><i class="app-menu__icon fa fa-globe"></i><span class="app-menu__label">Countries</span></a></li>
<?php } ?>
        </a>
        </li>
    </aside>
