...
.menu li ul li{
  background-color: #4637aa4f;
  
}  
.menu li:hover .app-menu__item{
  background-color: #4737aa;
  color: #fff;
} 
.menu ul, 
.menu ul li ul {
...
<?php }else{ ?>
        ...
        <li class="treeview" >
            <a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <span class="app-menu__label">Quotatios</span>
...
<?php }else{ ?>
        ...
        <li class="treeview" >
            <a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <span class="app-menu__label">Invoices</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
          <ul>
...
?>
        <li class="treeview">
          ...
          <ul class="submenu">
            ...
            <li><a class="treeview-item" href="manage_users.php"><i class="icon fa fa-pencil"></i> Manage Uses</a></li>
          </ul>
...
?>
        <li class="treeview" >
          ...
          <ul>
            <li><a class="treeview-item" href="report.php"><i class="icon fa fa-file"></i> Sent invoices </a></li>
            <li><a class="treeview-item" href="view_quatations_admin.php"><i class="icon fa fa-file"></i> Sent quotations</a></li>
          </ul>
        </li>
<?php }else{?>
        ...
        <li class="treeview" >
          ...
          <ul class="submenu">
            <li><a class="treeview-item" href="invoice_report_manager.php"><i class="icon fa fa-file"></i> Invoice Report</a></li>
            <li><a class="treeview-item" href="quotation_report_manager.php"><i class="icon fa fa-file"></i> Quotation Report</a></li>
          </ul>
<!--
           <li class="" >
