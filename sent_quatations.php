...
<div class="row">
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="page-header">
        <h2 class="pageheader-title"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> Sent Quotations</h2>
...
<div class="row">
 ...
 $con_id=country_by_user($conn,$_SESSION['idUsers']);
                                    ...
                                    $get_invoice = "SELECT * FROM student_registration2 WHERE delstatus=0 AND Country='$con_id' order by invoiceno DESC";
                            ...
                            <tr>
                                ...
                                while ($row_curency=mysqli_fetch_array($run_curency)) {
                                    ...
                                    echo "<td align=right>";
                                    echo $currency.' '.number_format($subtot, 2); ?> <?php //echo ; ?>
                                </td>
